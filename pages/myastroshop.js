...
<>
  ...
  <div className="as_main_wrapper">
    ...
    <section className="as_product_wrapper as_padderBottom80 as_productpadderTop80">
      <div className="container">
        <div className="row">
          <div className="col-lg-12 text-center summary">
            <h1 className="as_heading as_heading_center">Our Products</h1>
            <p className="as_font14 as_margin0 as_padderBottom20">
              Explore our incredible offers on gemstones, malas, rudrakshas, and
              more.
            </p>
            <div className="row">
